...
export const metadata: Metadata = {
  title: "Your Profile — Tegra Social",
};

export default async function ProfilePage() {
  // Demo mode: show first admin user's profile
  const rows = await db
    .select({
      id: user.id,
      name: user.name,
    ...
    <div className="p-8">
      <div className="max-w-2xl">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mb-8">
          Let your colleagues know who you are. Fill in your details and add
          some personality!
        </p>

        <ProfileForm profileData={profileData} isSetup={false} />
      </div>
    </div>
  );
}
